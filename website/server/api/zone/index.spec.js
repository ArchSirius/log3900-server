...
var zoneCtrlStub = {
  ...
  upsert: 'zoneCtrl.upsert',
  patch: 'zoneCtrl.patch',
...
describe('Zone API Router:', function() {
  ...
  describe('PUT /api/zones/:id', function() {
    it('should route to zone.controller.upsert', function() {
      routerStub.put
        .withArgs('/:id', 'zoneCtrl.upsert')
        .should.have.been.calledOnce;
    });
  });

  describe('PATCH /api/zones/:id', function() {
    it('should route to zone.controller.patch', function() {
      routerStub.patch
        .withArgs('/:id', 'zoneCtrl.patch')
        .should.have.been.calledOnce;
    });
  });
